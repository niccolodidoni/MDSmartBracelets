...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t smartBraceletC$Acks$requestAck(
#line 53
message_t * msg);
#line 85
static bool smartBraceletC$Acks$wasAcked(
#line 80
message_t * msg);
# 42 "smartBraceletC.nc"
...
static char *smartBraceletC$kinematic_string(uint8_t kinematic);
...
#line 244
{
  ...
  if (__nesc_ntoh_uint8(smartBraceletC$kinematic_status[sim_node()].nxdata) == 3 && smartBraceletC$role[sim_node()] == 0) {
      sim_log_debug(163U, "alert", "ALERT. FALLING status detected. Baby is in position (x=%u, y=%u)", __nesc_ntoh_uint16(smartBraceletC$x[sim_node()].nxdata), __nesc_ntoh_uint16(smartBraceletC$y[sim_node()].nxdata));
...
#line 78
# 257 "smartBraceletC.nc"
static inline message_t *smartBraceletC$Receive$receive(message_t *buf, void *payload, uint8_t len)
#line 257
{
  my_msg_t *msg = (my_msg_t *)payload;

  sim_log_debug(164U, "radio", "Packet received: {\n\tsnd=%u->rcv=%u\n\tkey=%s\n\ttype=%u\n\tpos=(%u, %u)\n\tkinematic status=%s\n}.\n", smartBraceletC$ReceivePacket$source(buf), smartBraceletC$ReceivePacket$destination(buf), msg->key, __nesc_ntoh_uint8(msg->msg_type.nxdata), __nesc_ntoh_uint16(msg->x.nxdata), __nesc_ntoh_uint16(msg->y.nxdata), smartBraceletC$kinematic_string(__nesc_ntoh_uint8(msg->kinematic_status.nxdata)));
...
#line 266
    if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == 3) {
        sim_log_debug(165U, "control", "Received Pairing Confirmation from other side\n");
      ...
      if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == 2 && __nesc_ntoh_uint8(smartBraceletC$mode[sim_node()].nxdata) == 2 && smartBraceletC$ReceivePacket$source(buf) == smartBraceletC$pair_addr[sim_node()]) {
          sim_log_debug(166U, "control", "Received Info from Child\n");
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb764d298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb764d298) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb764d298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t smartBraceletC$Acks$requestAck(message_t * msg){
#line 59
...
#line 59
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74c2c40, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74c2c40, addr, msg, len);
#line 80
...
#line 80
#line 110
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb765d8b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb765d8b0, msg, error);
#line 110
}
#line 110
...
inline static bool smartBraceletC$Acks$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb764d930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb764d930, msg, payload, len);
#line 78
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74c2258, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74c2258) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74c2258, msg, error);
#line 100
      break;
#line 100
    }
...
#line 104
# 112 "smartBraceletC.nc"
static inline void smartBraceletC$SerialSC$startDone(error_t err)
#line 112
{
  if (err == SUCCESS) {
      sim_log_debug(150U, "serial", "Serial bus active. \n");
      smartBraceletC$send_serial_packet(3, 0, 0);
    }
  else 
#line 116
    {
      sim_log_debug(151U, "serial", "Failed to activate the serial bus. Trying again. \n");
...
#line 55
# 169 "smartBraceletC.nc"
static inline void smartBraceletC$Milli10Timer$fired(void )
#line 169
{
  sim_log_debug(155U, "control", "Child timer fired\n");
...
#line 174
{
  sim_log_debug(156U, "alert", "MISSING ALERT! LAST KNOWN POSITION: x=%u,y=%u,kinematic_status=%s\n", __nesc_ntoh_uint16(smartBraceletC$x[sim_node()].nxdata), __nesc_ntoh_uint16(smartBraceletC$y[sim_node()].nxdata), smartBraceletC$kinematic_string(__nesc_ntoh_uint8(smartBraceletC$kinematic_status[sim_node()].nxdata)));
...
#line 24
{
  ...
  sim_log_debug(207U, "kinetic_sensor", "RANDOM VALUE READY: %d\n", num);
...
#line 43
  sim_log_debug(208U, "kinetic_sensor", "VALUE READ: %d\n", status);
...
#line 300
  ...
  if (result != SUCCESS) {
      sim_log_debug(170U, "app_sensor", "Error in reading sensor data. \n");
      return;
    }

  sim_log_debug(171U, "app_sensor", "Data received from sensor: {\n\tkinetic_status=%u\n\tposition=(x=%u, y=%u)\n}\n", data.kinematic_status, __nesc_ntoh_uint16(data.x.nxdata), __nesc_ntoh_uint16(data.y.nxdata));
...
#line 40
  ...
  sim_log_debug(209U, "complete_sensor", "DATA READ: {\n\tkinematic_status=%u\n\tposition=(x=%u, y=%u)\n}\n", data.kinematic_status, __nesc_ntoh_uint16(data.x.nxdata), __nesc_ntoh_uint16(data.y.nxdata));
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb7344c70){
#line 83
  switch (arg_0xb7344c70) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb7344c70);
#line 83
      break;
#line 83
    }
...
#line 63
{
  ...
  sim_log_debug(148U, "boot", "Application booted with key %s.\n", smartBraceletC$key[sim_node()]);
}
...
#line 223
{
  ...
  if (is_pairing && smartBraceletC$pair_addr[sim_node()] == AM_BROADCAST_ADDR) {
      if (strcmp(smartBraceletC$key[sim_node()], received->key) == 0) {
          ...
          sim_log_debug(161U, "control", "PAIRING WITH: %u\n", smartBraceletC$pair_addr[sim_node()]);

          __nesc_hton_uint8(smartBraceletC$mode[sim_node()].nxdata, 3);
...
#line 236
    if (!is_pairing && smartBraceletC$pair_addr[sim_node()] != TOS_NODE_ID) {
        ...
        sim_log_debug(162U, "control", "Confirmation for PAIREND received, count: %u\n", __nesc_ntoh_uint8(smartBraceletC$confirmation[sim_node()].nxdata));
...
#line 135
{
  ...
  if (smartBraceletC$locked[sim_node()]) {
      sim_log_debug(152U, "radio", "Radio locked. Skipping signaling packet. \n");
      return;
    }
...
#line 144
  ...
  smartBraceletC$Acks$requestAck(&smartBraceletC$packet[sim_node()]);
  if (smartBraceletC$AMSend$send(dest, &smartBraceletC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(153U, "radio", "packet sent: {\n\tsnd=%u->rcv=%u\n\tkey=%s\n\ttype=%u\n\tpos=(%u, %u)\n\tkinematic status=%s\n}.\n", smartBraceletC$SendPacket$source(&smartBraceletC$packet[sim_node()]), smartBraceletC$SendPacket$destination(&smartBraceletC$packet[sim_node()]), msg->key, __nesc_ntoh_uint8(msg->msg_type.nxdata), __nesc_ntoh_uint16(msg->x.nxdata), __nesc_ntoh_uint16(msg->y.nxdata), smartBraceletC$kinematic_string(__nesc_ntoh_uint8(msg->kinematic_status.nxdata)));



      smartBraceletC$locked[sim_node()] = TRUE;
      sim_log_debug(154U, "radio", "radio locked.\n");
    }
}
...
#line 207
  ...
  sim_log_debug(158U, "radio", "Packet sent successfully. \n");

  if (__nesc_ntoh_uint8(smartBraceletC$mode[sim_node()].nxdata) == 3 && smartBraceletC$Acks$wasAcked(buf)) {
      ...
      sim_log_debug(159U, "control", "Ack for PAIREND send received, count: %u\n", __nesc_ntoh_uint8(smartBraceletC$confirmation[sim_node()].nxdata));
      smartBraceletC$isPairingDone(__nesc_ntoh_uint8(smartBraceletC$confirmation[sim_node()].nxdata));
    }
  else {
#line 216
    if (__nesc_ntoh_uint8(smartBraceletC$mode[sim_node()].nxdata) == 3) {
        sim_log_debug(160U, "control", "Confirmation for PAIREND resent, Ack was not received\n");
        smartBraceletC$send_packet(smartBraceletC$pair_addr[sim_node()], 3, 0, 0, 0);
      }
    }
}
...
{
  if (conf == 2) {
      sim_log_debug(157U, "control", "Ending Pairing phase, going into Operation mode\n");
